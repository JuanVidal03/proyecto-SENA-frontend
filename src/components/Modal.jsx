...
const Modal = ({ content }) => {
    ...
    return (
        ...
        <div className={`${ modalState ? "opacity-100 visible" : "opacity-0 hidden" } p-10 fixed top-0 left-0 inset-0 bg-[#000000c9] backdrop-blur-xl z-[100] overflow-hidden w-full h-full flex justify-center items-center transition-all`}>
