    ...
    <section className="w-full h-screen relative overflow-hidden flex justify-center items-center">
      <div className="bg-white w-full max-w-[1000px] h-[75%] flex relative z-[9] rounded-xl shadow-login">
        <div className="w-full max-w-[50%] p-4 flex items-center justify-center flex-col">
          ...
          */}
          <div className="text-azul-fuerte w-full h-[60%] flex justify-center items-center">
            <form className="w-[60%] flex flex-col" onSubmit={clickBotonIniciar}>
              ...
              <div className="flex justify-center items-center">
                <button className="border-none bg-azul-fuerte font-bold text-white text-[1rem] cursor-pointer py-3 w-full rounded-lg mt-2" type="submit">
                  Ingresa
                </button>
              </div>
            </form>
        ...
        <figure className="w-full relative max-w-[50%] after:w-full after:h-full after:absolute after:left-0 after:top-0 after:bg-azul-gradiente after:content-[''] after:z-[2] after:rounded-tr-xl after:rounded-br-xl">
          <img className="w-full h-full object-cover z-[1] absolute rounded-tr-xl rounded-br-xl" src={imgLogin} alt="" />
        </figure>
      </div>
